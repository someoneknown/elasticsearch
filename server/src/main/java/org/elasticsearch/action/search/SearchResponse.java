...
public class SearchResponse extends ActionResponse implements StatusToXContentObject {
    ...
    private static final ParseField SEEK_COUNT_DOC_VALUES = new ParseField("seek_count_doc_values");
    private static final ParseField SEEK_TIME_DOC_VALUES = new ParseField("seek_time_doc_values");
    ...
    public SearchResponse(StreamInput in) throws IOException {
        ...
        seekTimeDocValues = in.readVLong();
    ...
    /**
     * Total number of seek in doc values
     */
    ...
    /**
     * Total time for seek in doc values
     */
    ...
    public XContentBuilder innerToXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        builder.field(SEEK_TIME_DOC_VALUES.getPreferredName(), seekTimeDocValues);
    ...
    public static SearchResponse innerFromXContent(XContentParser parser) throws IOException {
        ...
        for (Token token = parser.nextToken(); token != Token.END_OBJECT; token = parser.nextToken()) {
            if (token == Token.FIELD_NAME) {
                ...
                } else if (SEEK_COUNT_DOC_VALUES.match(currentFieldName, parser.getDeprecationHandler())) {
                    seekCountDocValues = parser.intValue();
                } else if (SEEK_TIME_DOC_VALUES.match(currentFieldName, parser.getDeprecationHandler())) {
                    seekTimeDocValues = parser.longValue();
                } else {
                    parser.skipChildren();
                }
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        out.writeVLong(seekTimeDocValues);
